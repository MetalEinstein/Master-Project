...
class Selection:
    def __init__(self, population, popRanked, pickSize, selectionSize):
    ...
    def tournament_selection(self):
        ...
        # Choose individuals to the mating pool through tournament selection
        for i in range(0, self.pickSize):
